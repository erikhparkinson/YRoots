...
- (void)testFunction1DBasic {
    ...
    Function tempFunction(functionString, variableNames, subfunctions);
    ...
    Function tempFunction11(functionString, variableNames, subfunctions);
    inputPoints[0] = 2;
